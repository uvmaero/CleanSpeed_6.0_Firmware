...
// Sensors
const uint8_t PUMP_TEMP_IN_PIN =            41;
const uint8_t PUMP_TEMP_OUT_PIN =           42;

#define BMS_FAULT_PIN                       8
#define IMD_FAULT_PIN                       9

#define VICORE_FAULT_PIN                    18

#define FR_HALL_EFFECT_PIN                  28
#define FL_HALL_EFFECT_PIN                  27
#define BR_HALL_EFFECT_PIN                  26
#define BL_HALL_EFFECT_PIN                  25
...
#define COAST_REGEN_PIN                     10
#define BRAKE_REGEN_PIN                     11

#define START_BUTTON_PIN                    29
#define DRIVE_MODE_BUTTON_PIN               37
#define TRACTION_CONTROL_SWITCH_PIN         12
...
// Outputs
#define RTD_LED_PIN                         17
#define DRIVE_MODE_LED_PIN                  36

#define BMS_FAULT_IND_PIN                   16
#define IMD_FAULT_IND_PIN                   15

#define TSSI_FAULT_IND_PIN                  13

#define VICORE_ENABLE_PIN                   19

#define BUZZER_PIN                          20

constexpr uint8_t BRAKE_LIGHT_PIN =         34;

#define FAN_ENABLE_PIN                      35
...
constexpr float PEDAL_MIN =                  0;       // minimum value the pedals can read as
constexpr float PEDAL_MAX =                  255;     // maximum value a pedal can read as
